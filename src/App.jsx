  ...
  const [books, setBooks] = useState([
    {
      ...
      image: Image3,
      description:
        "Irqchilik va adolat mavzularini yorituvchi Amerikadagi klassik roman. To Kill a Mockingbird",
    },
    {
      id: 2,
      title: "1984",
      ...
      image: Image1,
      description:
        "Fresh and vibrant green bell pepper, perfect for adding color and flavor to your dishes. 1984",
    },
    {
      id: 3,
      ...
      image: Image2,
      description:
        "Amerika orzusi, boylik va muhabbat haqida zamonaviy tragik hikoya. The Great Gatsby",
    },
    {
      id: 4,
      ...
      image: Image5,
      description:
        "Oila, ijtimoiy tabaqalanish va sevgi haqida ingliz romantik klassikasi. Pride and Prejudice",
    },
    {
      id: 5,
      ...
      image: Image4,
      description:
        "Sehrli maktabda o‘qiydigan bolakay va uning sehrgar do‘stlari sarguzashtlari. Harry Potter and the Sorcerer's Stone",
    },
    {
      id: 6,
      title: "Yashamoq",
      ...
      image: Image6,
      description:
        "Hayot mazmuni, insoniy azob va kuchli hissiyotlar bilan boy asar. Yashamoq",
    },
    {
      id: 7,
      title: "POSTER STOP",
      ...
      image: Image7,
      description:
        "Death Note mangasiga oid posteri – mashhur anime va manga seriyasi uchun. POSTER STOP",
    },
    {
      id: 8,
      title: "One Piece",
      ...
      image: Image8,
      description:
        "Dunyo bo‘ylab xazina izlayotgan qaroqchi Luffy va uning jamoasining epik sarguzashtlari. One Piece",
    },
    {
      id: 9,
      ...
      image: Image9,
      description:
        "Insoniyat gigant titanlarga qarshi kurashayotgan post-apokaliptik hikoya. Атака на титанов",
    },
    {
      id: 10,
      title: "📘 Berserk",
      ...
      image: Image10,
      description:
        "Guts ismli jangchining qorong‘i fantaziya dunyosidagi halokatli sarguzashtlari. 📘 Berserk",
    },
    {
      id: 11,
      title: "📘 Monster",
      ...
      image: Image11,
      description:
        "Bir shifokorning psixopat bemorini qutqarishi ortidan boshlangan ruhiy triller. 📘 Monster",
    },
    {
      id: 12,
      title: "📘 Vinland Saga",
      ...
      image: Image12,
      description:
        "Vikinglar hayoti, urush va kechirim haqida tarixiy manga. 📘 Vinland Saga",
    },
    {
      id: 13,
      title: "Case Closed",
      ...
      image: Image13,
      description:
        "Yosh detektiv Conan Edogawa jinoyatlarni hal qiluvchi intellektual hikoya. Case Closed",
    },
    {
      id: 14,
      title: "Oʻtkan kunlar",
      ...
      image: Image14,
      description:
        "O‘zbek adabiyotidagi birinchi roman – muhabbat, jamiyat va islohotlar haqida. Oʻtkan kunlar",
    },
    {
      id: 15,
      ...
      image: Image15,
      description:
        "Diniy niqob ortidagi zo‘ravonlik va ijtimoiy zulm haqida tanqidiy roman. Mehrobdan chayon",
    },
    {
      id: 16,
      title: "Qutlugʻ qon",
      ...
      image: Image16,
      description:
        "Amir Temur davri va tarixiy voqealarni aks ettiruvchi o‘zbek tarixiy asari. Qutlugʻ qon",
    },
    {
      id: 17,
      title: "Hamlet",
      ...
      image: Image17,
      description:
        "Xushchaqchaq va sho‘x bolakayning sarguzashtli va hazilomuz hayoti. „Shum bola“",
    },
    {
      id: 18,
        ...
        <header className=" container pt-15 pb-10 leading-relaxed bg-purple-600  flex items-center justify-center">
          <ul class="centered-list">
            <a class="flex gap-2 items-center logo-family text-2xl" href="">
              <span class="rounded-[50%] border-2 p-2 border-pink-300 text-pink-500  bg-fuchsia-400">
                &Nilush
              </span>
            </a>
              ...
              return (
                <div className="card bg-base-100 h-150 w-96 shadow-sm hover:bg-fuchsia-500 mt-20">
                  ...
                  <div className="card-body">
                    <h2 className="card-title  caret-purple-800">
                      {book.title}
                    </h2>
                    ...
                    <div className="card-actions justify-end">
                      <button className="btn btn-dash btn-primary w-80 pl-20 pr-20 h-20">
                        BUY NOOSh
                      </button>
                    </div>
                  </div>
          ...
          <footer className="footer sm:footer-horizontal bg-neutral text-neutral-content items-center p-4 mt-20">
            ...
            <div className="avatar">
              <div className="w-32 rounded">
                <img
                  src="https://covers.openlibrary.org/b/id/10523338-L.jpg"
                  alt="Book Cover 1"
                />
              </div>
            </div>
